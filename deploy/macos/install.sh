...
# Extraction provider. heuristic = rule-based, in-process, no network — works
# out of the box. For richer extraction, run Ollama natively (Metal-accelerated)
# and flip to the remote provider:
